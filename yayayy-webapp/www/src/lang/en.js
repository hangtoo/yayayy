export default {
  route: {
    ...
    extConfigparam: 'Config Param',
    tApilog: 'Log',
    tCustomer: 'Custom manage',
    tcustomer: 'Custom manage',
    tCustomerInvest: 'Order manage',
    tInvestInfo: 'Invest manage',
    tBusiness: 'Business',
    tBanner: 'Banner manage',
    tPromotion: 'Promotion',
    tArticle: 'Article',
    tArticleAdv: 'ArticleAdv',
    tCustomerFrom: 'Channel statistics',
